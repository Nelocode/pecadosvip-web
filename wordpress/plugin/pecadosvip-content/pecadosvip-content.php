...
function pvc_fields(string $type): array {
    ...
    $specific = array(
        'pv_profile' => array(
            ...
            'phoneMadrid' => array('label' => 'Teléfono (Madrid)', 'type' => 'string'),
              'whatsappMadrid' => array('label' => 'WhatsApp (Madrid, URL completa)', 'type' => 'string'),
...
function pvc_copy(string $locale): array {
    ...
    $public_groups = array('brand', 'contact', 'discretion', 'profileFields', 'coverage', 'filters', 'footer', 'hero', 'legal', 'nativeUi', 'navigation', 'profile', 'profilesSection', 'security', 'services', 'servicesSection', 'site', 'trustSignals', 'languageName');
