...
export function makeSeed(media: Record<string, string>, sourceCommit: string) {
  ...
  for (const locale of SUPPORTED_LOCALES) {
    ...
    copy[locale] = { ...presentation, contact: getContactCopy(locale), legal: getLegalCopy(locale), discretion: getDiscretionCopy(locale), profileFields: getProfileFieldsCopy(locale), services, nativeUi: labels[locale], site: {
